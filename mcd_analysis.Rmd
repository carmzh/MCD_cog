...
redcap_mcd_data <- read.csv("/Users/carmen/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/PhD/data/study-2/AustralianEpilepsyPr-MCDPatientsNpsychSco_DATA_2024-05-06_1549.csv")
```
...
# for each id, if the sum of lesion is three/two/one/zero, code this numerical sum in colname = num_mcd
for (id in unique_id) {
