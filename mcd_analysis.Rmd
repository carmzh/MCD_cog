...
mcd_data = read.csv("/Users/carmen/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/PhD/data/study-2/AustralianEpilepsyPr-MCDPatientCharacteri_DATA_2024-07-01_1350.csv")
...
redcap_mcd_data <- read.csv("/Users/carmen/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/PhD/data/study-2/AustralianEpilepsyPr-MCDPatientsNpsychSco_DATA_2024-07-01_1351.csv")
```

# Patient characeristics (all):
...
## set up REDCap npsych data

```{r}
redcap_mcd_data <- redcap_mcd_data[-c(2:4)] # removed rrededcap generated event indices
...
## RQ1 - single pathology associated with >=1 impaired cog domain

```{r}
# define cognitive domains by tests
